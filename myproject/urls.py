...
urlpatterns = [
    ...
    path('api/projectdetails/<int:project_id>/scripts/', FetchScriptView.as_view(), name='project_scripts'),

    # Script Generation
    path('api/generate-script/', GenerateScriptAPIView.as_view(), name='generate_script'),

    # Monitoring Data APIs
    path('api/monitoring/', receive_metrics, name='receive_metrics'),
    path('api/post-monitor-data/', post_monitor_data, name='post_monitor_data'),
    path('api/get-monitor-data/', get_monitor_data, name='get_monitor_data'),  # Newly added endpoint
    path('api/monitoring-data/', MonitoringDataView.as_view(), name='monitoring_data'),  # From class-based view
