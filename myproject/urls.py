...
from myapps.views import InfoAPIView, ScriptAPIView, ToolAPIView, RegisterUserAPIView  # Import necessary views
...
urlpatterns = [
    ...
    path('api/scripts/<str:stage>/', ScriptAPIView.as_view(), name='get_scripts'),  # API for retrieving scripts
